 ...
 <div className="min-h-screen">
      ...
      <header className="text-center py-10">
        <div className="flex items-center justify-center mb-2">
          <span className="w-20 h-1 bg-red-500 mr-2"></span>
          <h2 className="text-sm font-roboto tracking-wide text-primary uppercase">Dream. Explore. Discover</h2>
        </div>
        <h1 className="text-5xl font-bold mt-4 text-[#927B64]">DIVE INTO A WORLD OF </h1>
        <h1 className="text-5xl font-bold mt-4 text-[#927B64]">INSPIRATION</h1>

        <p className="mt-6 text-base max-w-2xl mx-auto text-gray-600">
Mackinnons Travels Dive into a world of inspiration, insights, and ideas. Whether you're here to explore, learn, or simply unwind, 
our blog brings stories that resonate and topics that spark curiosity. Dive into a world of inspiration, insights, and ideas. at in. 
Aliquet pharetra ut pellentesque non etorem volutpat cras adipiscing non donec quis proin sit. Cum tincidunt proin faucibus nulla. Mauris scelerisque urna urna consectetur.</p>
      </header>

      <div className="flex justify-center space-x-4 mb-10">
        <button className="bg-[#F5F4F1] py-2 px-4 rounded-full">Categories</button>
      ...
      <div className="flex justify-center space-x-4 text-gray-600">
       ...
       <div className="grid grid-cols-1 md:grid-cols-2 gap-2 ml-20  mt-20">
       <div className="flex flex-col group mb-15">
         <Link href="/blog" className="block">
           <div className="relative rounded-3xl overflow-hidden shadow-md w-[600px] h-[400px] mb-4 cursor-pointer">
             <Image
       ...
       <div className="flex flex-col group mb-15">
         <div className="relative rounded-2xl overflow-hidden shadow-md w-[600px] h-[400px] mb-4">
           <Image
       ...
       <div className="absolute inset-0 bg-gradient-to-b from-black/40 to-transparent h-1/3 z-0"></div>
           ...
           <div className="absolute bottom-0 left-0 right-0 h-2 bg-[#6804b4] rounded-b-3xl"></div>
         </div>
         <div className="text-left">
           <p className="text-xs text-primary font-bold mb-1 leading-6">28 JULY 2024</p>
           <p className="text-lg font-semibold text-[#6d563b] leading-8">
