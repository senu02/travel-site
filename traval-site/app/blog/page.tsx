    ...
    <div className="min-h-screen">
      ...
      <section className="flex flex-col items-center px-4">  
        <div className="mb-8 mt-10 flex flex-col items-start w-full max-w-6xl px-4">  
          <p className="text-sm font-roboto font-bold text-[#927B64] tracking-widest leading-7 mb-1">09 OCT 2024</p>
      ...
      <section className="flex justify-center mt-10 md:mt-20 mb-5 px-4">  
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 w-full max-w-6xl"> 
          <div className="flex flex-col group mb-5">
            <div className="relative rounded-3xl overflow-hidden shadow-md w-full h-[200px] sm:h-[250px] md:h-[300px] lg:h-[349px] mb-4 cursor-pointer">  {/* Responsive height */}
              <Image
                src="/images/1.jpg"
                alt="Travel 2"
                fill
          ...
          <div className="flex flex-col group mb-5">
            <div className="relative rounded-3xl overflow-hidden shadow-md w-full h-[200px] sm:h-[250px] md:h-[300px] lg:h-[349px] mb-4 cursor-pointer">  
              <Image
                src="/images/2.jpg"
                alt="Travel 2"
                fill
      ...
      <section className="flex justify-center mb-10 mt-10 px-4">  
        <svg width="100%" height="15" viewBox="0 0 1441 15" fill="none" xmlns="http://www.w3.org/2000/svg" className="max-w-[1441px]">  
          <line x1="749" y1="8.5" x2="1441" y2="8.5" stroke="#B9AB96" strokeOpacity="0.38"/>  
          <line x1="-4.37114e-08" y1="8.5" x2="692" y2="8.49994" stroke="#B9AB96" strokeOpacity="0.38"/>  
      ...
      <section className="flex flex-col items-center px-4">      
        <div className="mb-8 flex flex-col items-center w-full max-w-6xl">  
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-normal text-[#927B64] font-antonio uppercase mt-8 tracking-tight leading-tight mb-6"> 
          </h2>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">  
            <div className="border border-[#CECECE] rounded-3xl shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              <div className="w-full h-60 sm:h-72 md:h-80 relative rounded-3xl rounded-b-3xl overflow-hidden">  
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-b from-black/40 to-transparent h-1/3 z-0"></div>
                <div className="absolute top-4 left-4 text-white text-xs sm:text-sm tracking-wider font-roboto font-semibold z-10 leading-6 uppercase">Air ticket </div>
                <div className="absolute bottom-4 right-4 z-10"></div>
                <div className="absolute bottom-0 left-0 right-0 h-2 bg-[#F1C40F] rounded-t-full"></div>
              </div>
              <div className="p-4">
                <h1 className="font-bold font-roboto text-primary mb-2 sm:mb-4 text-sm sm:text-base uppercase">Asia</h1>
                <h3 className="font-normal font-antonio text-2xl sm:text-3xl md:text-4xl text-primary mb-2 uppercase leading-tight">THAILAND</h3>
                <p className="text-primary font-roboto font-normal tracking-wider text-xs sm:text-sm mt-4 sm:mt-10">04 Nights | P/P</p>
                <p className="text-xl sm:text-2xl font-roboto font-bold text-[#002D6A] mb-2 sm:mb-4">LKR 710,000</p>
                <button className="py-2 px-4 rounded-full uppercase font-semibold font-roboto text-xs sm:text-sm transition-colors bg-[#002D6A] text-[#ffffff] border border-transparent hover:border-[#927B64] hover:bg-[#ffffff] hover:text-[#927B64]">BOOK NOW</button>
              </div>
            </div>
            ...
            <div className="border border-[#CECECE] rounded-3xl shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              <div className="w-full h-60 sm:h-72 md:h-80 relative rounded-3xl rounded-b-3xl overflow-hidden">  
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-b from-black/40 to-transparent h-1/3 z-0"></div>
                <div className="absolute top-4 left-4 text-white text-xs sm:text-sm tracking-wider font-semibold z-10 leading-6 uppercase">Air ticket </div>
                <div className="absolute bottom-4 right-4 z-10"></div>
              ...
              <div className="p-4">
                <h1 className="font-bold font-roboto text-primary mb-2 sm:mb-4 text-sm sm:text-base uppercase">Asia</h1>
                <h3 className="font-normal font-antonio text-2xl sm:text-3xl md:text-4xl text-primary mb-2 uppercase leading-tight">THAILAND</h3>
                <p className="text-primary font-roboto font-normal tracking-wider text-xs sm:text-sm mt-4 sm:mt-10">02 Nights | P/P</p>
                <p className="text-xl sm:text-2xl font-roboto font-bold text-[#002D6A] mb-2 sm:mb-4">LKR 350,000</p>
                <button className="py-2 px-4 rounded-full uppercase font-semibold font-roboto text-xs sm:text-sm transition-colors bg-[#002D6A] text-[#ffffff] border border-transparent hover:border-[#927B64] hover:bg-[#ffffff] hover:text-[#927B64]">BOOK NOW</button>
              </div>
            </div>
            ...
            <div className="border border-[#CECECE] rounded-3xl shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <div className="p-4">
                <h1 className="font-bold font-roboto text-primary mb-2 sm:mb-4 text-sm sm:text-base uppercase">09 Sep 2024 - 11 OCT 2024 </h1>
                <h3 className="font-normal font-antonio text-2xl sm:text-3xl md:text-4xl text-primary mb-2 uppercase leading-tight">Colombo - MALE</h3>
                <p className="text-primary font-roboto font-normal tracking-wider text-xs sm:text-sm mt-4 sm:mt-10">Round-trip  |  Business</p>
                <p className="text-xl sm:text-2xl font-roboto font-bold text-[#002D6A] mb-2 sm:mb-4">LKR 90,000</p>
                <button className="py-2 px-4 rounded-full uppercase font-semibold font-roboto text-xs sm:text-sm transition-colors bg-[#002D6A] text-[#ffffff] border border-transparent hover:border-[#927B64] hover:bg-[#ffffff] hover:text-[#927B64]">BOOK NOW</button>
              </div>
            </div>
            ...
            <div className="border border-[#CECECE] rounded-3xl shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <div className="p-4">
                ...
                <h3 className="font-normal font-antonio text-2xl sm:text-3xl md:text-4xl text-primary mb-2 uppercase leading-tight">THAILAND</h3>
                <p className="text-primary font-roboto font-normal tracking-wider text-xs sm:text-sm mt-4 sm:mt-10">04 Nights | P/P</p>
                <p className="text-xl sm:text-2xl font-roboto font-bold text-[#002D6A] mb-2 sm:mb-4">LKR 520,000</p>
                <button className="py-2 px-4 rounded-full uppercase font-semibold font-roboto text-xs sm:text-sm transition-colors bg-[#002D6A] text-[#ffffff] border border-transparent hover:border-[#927B64] hover:bg-[#ffffff] hover:text-[#927B64]">BOOK NOW</button>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 w-full"> 
              <div className="flex flex-col group mb-4">
                ...
                <div className="text-left">
                  <span className="text-xs sm:text-sm text-[#927B64] font-bold font-roboto uppercase block mb-2 mt-4 sm:mt-10">09 AUG 2024</span>
