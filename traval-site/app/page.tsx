  ...
  <section className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[644px_1fr] gap-4 lg:gap-6 font-antonio uppercase">
    ...
    <div className="flex flex-col lg:pl-0">
      <div className="mb-4 lg:mb-6">
        ...
        <h2 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-medium font-antonio text-[#927B64] mt-2 leading-[1.2]">
      ...
      <div className="relative">
        ...
        <section className="py-10 px-6 md:px-10  mt-20 relative z-10">
          <div className="flex flex-col items-center text-center mb-12">
            <div className="flex items-center mb-4">
              <span className="w-8 h-0.5 bg-red-500 mr-2"></span>
              <p className="text-lg font-roboto  text-[#6d563b] uppercase font-bold tracking-widest text-primary-500">
                INSIGHT AND IDEAS
              </p>
            </div>
            <h2 className=" font-antonio text-[#6d563b] text-8xl uppercase mb-4 font-normal">OTHER STORIES</h2>
          </div>
