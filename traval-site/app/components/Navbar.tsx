...
export default function Navbar() {
  ...
  return (
    <>
      ...
      >
        <div className="flex items-center justify-between px-4 sm:px-6 py-6 w-full relative bg-white shadow-sm">
          ...
          <nav className="flex items-center justify-between w-full mt-4 relative z-10 ml-10 mr-10">
            ...
            {/* Center logo - now using flex instead of absolute positioning */}
      ...
      >
        <div className="max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 py-3 text-primary">
          <div className="flex items-center gap-4 sm:gap-8 flex-1">
            ...
            <Link
              href="#"
              className={`hover:text-black font-roboto font-bold text-sm sm:text-base ${
                pathname === "#" ? "text-[#002D6A]" : ""
              }`}
            >
              Travel Packages
