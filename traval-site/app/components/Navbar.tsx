...
export default function Navbar() {
 ...
 <svg 
          ...
          >
            ...
            <path d="M93.8914 18.4281C93.8914 19.0573 93.4079 19.5676 92.8115 19.5676C92.2153 19.5676 91.7318 19.0573 91.7318 18.4281C91.7318 17.7987 92.2153 17.2886 92.8115 17.2886C93.4079 17.2886 93.8914 17.7987 93.8914 18.4281Z" fill="white"/>
            <circle cx="24" cy="24" r="23.5" stroke="#927B64"/>
            <path d="M25.203 33.4022V25.0087H28.0192L28.4417 21.7366H25.203V19.6479C25.203 18.7009 25.4649 18.0555 26.8245 18.0555L28.5557 18.0547V15.1281C28.2563 15.0892 27.2286 15 26.0325 15C23.5347 15 21.8248 16.5246 21.8248 19.3238V21.7366H19V25.0087H21.8248V33.4022H25.203Z" fill="#927B64"/>
            <circle cx="152" cy="24" r="23.5" stroke="#927B64"/>
            <path d="M160.995 33L161 32.9992V26.031C161 22.622 160.266 19.9961 156.281 19.9961C154.365 19.9961 153.079 21.0474 152.555 22.0441H152.499V20.3143H148.72V32.9992H152.655V26.7181C152.655 25.0643 152.969 23.4652 155.017 23.4652C157.035 23.4652 157.065 25.3525 157.065 26.8242V33H160.995Z" fill="#927B64"/>
            <path d="M142.314 20.3151H146.253V33H142.314V20.3151Z" fill="#927B64"/>
