      ...
      <div className="flex flex-1 justify-center">
        <div className="mx-auto">
          <Image
            src="/images/logo.png"
            alt="Logo"
            width={isFixed ? 190 : 280}
            height={isFixed ? 160 : 280}
            className={`w-[${isFixed ? "150px" : "180px"}] `}
          />
        </div>
      </div>
  ...
  return (
    <>
      <header className="z-30">
        <div className="relative flex w-full items-center justify-between bg-white px-0 py-0 shadow-sm sm:px-6 sm:py-6">
          <div
