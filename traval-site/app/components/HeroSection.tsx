    ...
    <section className="relative h-screen">
      <main className="grid grid-cols-1 md:grid-cols-2 gap-8 px-1 py-10 items-center">
        <div className="flex items-center space-x-8">
          <Image src="/images/bg.png" alt="img" width={300} height={300} className="rounded-xl flex mt-50 "/>
          <div className="space-y-6">
            ...
            <h1 className="text-4xl font-antonio font-normal uppercase text-[#927B64] leading-tight"> Adventure Awaits<br />Around the World </h1>
